// TODO: IMPORTANT - Add HTML escaping for all dynamic email template placeholders.
                        ...
                        <td class="mobile-padding" style="padding: 40px 40px 40px 40px;">
                            ...
                            <p class="mobile-text dark-text-muted" style="margin: 40px 0 0 0; font-size: 14px; line-height: 1.5; color: #CCDADC !important; text-align: center;">
                               Stox HQ, 200 Market Street, San Francisco, CA 94105<br>
                                ...
                                <a href="{{dashboardUrl}}" style="color: #CCDADC !important; text-decoration: underline;">Visit Stox</a><br>
                                © 2025 Stox
                            </p>
                        </td>
                    </tr>
